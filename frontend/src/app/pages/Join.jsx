  ...
  return (
    <section id="join" className={styles.join}>
      <div className="container">
        <SectionHeader label="careers" title="Join" accent="NOVEx" />
        ...
        <div className={`${styles.grid} fade-up`} ref={ref}>
          <div className={styles.card}>
            ...
            <div className={styles.chips}>
              {JOIN_POSITIONS.map(r => <span key={r} className={styles.chip}>{r}</span>)}
            </div>
            <a href={`mailto:${COMPANY.email}?subject=Job Application`} className="btn-primary">
              apply now →
            </a>
          </div>
          ...
          <div className={styles.card}>
            ...
            <div className={styles.chips}>
              {JOIN_CONTRIB.map(r => <span key={r} className={styles.chip}>{r}</span>)}
            </div>
            <a href={COMPANY.github} className="btn-secondary" target="_blank" rel="noreferrer">
              view repositories
            </a>
          </div>
        </div>
